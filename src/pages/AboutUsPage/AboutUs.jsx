            ...
            <section className="my-10 p-6 bg-white shadow-lg rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center">
                        <img src="https://avatars.githubusercontent.com/u/154998814?v=4" alt="Team Member" className="w-full min-h-[50vh] object-cover rounded-lg shadow-md" />
                        <h3 className="mt-4 text-lg font-bold text-gray-800">Rana Mubashir</h3>
                        <p className="text-gray-600">CEO</p>
                    </div>
                    <div className="text-center">
                        <img src="https://avatars.githubusercontent.com/u/132738567?v=4" alt="Team Member" className="w-full min-h-[50vh] object-cover rounded-lg shadow-md" />
                        <h3 className="mt-4 text-lg font-bold text-gray-800">Faraz Ahmad</h3>
                        <p className="text-gray-600">CTO</p>
                    </div>
                    <div className="text-center">
                        <img src="/images/team3.jpg" alt="Team Member" className="w-full min-h-[50vh] object-cover rounded-lg shadow-md" />
